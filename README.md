...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-zeallot-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-zeallot-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-zeallot-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-zeallot-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-zeallot-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-zeallot-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-zeallot` can be installed with:

```
conda install r-zeallot
```

It is possible to list all of the versions of `r-zeallot` available on your platform with:
